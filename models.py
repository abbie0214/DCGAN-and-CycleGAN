...
class DCGenerator(nn.Module):
    def __init__(self, noise_size, conv_dim):
        ...
        self.upconv2 = upconv(2 * conv_dim, conv_dim, 5)
...
class CycleGenerator(nn.Module):
    ...
    def __init__(self, conv_dim=64, init_zero_weights=False):
        ...
        self.upconv1 = upconv(2 * conv_dim, conv_dim, 5)
...
class DCDiscriminator(nn.Module):
    ...
    def __init__(self, conv_dim=64, spectral_norm=False): # actually 32
        ...
        self.conv3 = conv(2 * conv_dim, 4 * conv_dim,5,spectral_norm=spectral_norm)
        self.conv4 = conv(4 * conv_dim, 1, 5, 2, 1, batch_norm=False)
